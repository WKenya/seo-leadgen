...
- Status note (2026-03-15): suppression keys are canonicalized (`email` lowercase; URL/domain forms -> hostname), runtime checks include legacy-row normalization fallback, and suppression read responses normalize legacy URL rows.
