...
class SummarizeTaskTests(unittest.TestCase):
    ...
    def test_is_suppressed_matches_website_domain_with_port(self) -> None:
        lead = summarize.Lead(
            id=uuid4(),
            name="Acme HVAC",
            category="HVAC",
    ...
    def test_is_suppressed_matches_whitespace_padded_website_url_domain(self) -> None:
        lead = summarize.Lead(
            id=uuid4(),
            name="Acme HVAC",
            category="HVAC",
    ...
    def test_is_suppressed_matches_schemeless_website_url_domain(self) -> None:
        lead = summarize.Lead(
            id=uuid4(),
            name="Acme HVAC",
            category="HVAC",
            source="test",
            website_url="acme.example/home",
            website_domain=None,
            email=None,
            status="Audited",
        )
    ...
    def test_is_suppressed_matches_website_url_domain_with_port(self) -> None:
        lead = summarize.Lead(
            id=uuid4(),
            name="Acme HVAC",
            category="HVAC",
            source="test",
            website_url="https://acme.example:443/home",
            website_domain=None,
            email=None,
            status="Audited",
        )
    ...
    def test_is_suppressed_matches_legacy_url_suppression_row_with_userinfo(self) -> None:
        lead = summarize.Lead(
            id=uuid4(),
            name="Acme HVAC",
            category="HVAC",
